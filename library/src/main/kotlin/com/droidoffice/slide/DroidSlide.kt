...
/**
 * Entry point for DroidSlide library initialization.
 *
 * ```kotlin
 * // Commercial use: call once in Application.onCreate()
 * DroidSlide.initialize(context, licenseKey = "XXXXXXXX-XXXX-XXXX-XXXX")
 *
...
object DroidSlide {
    ...
    /**
     * Initialize DroidSlide with a Gumroad license key for commercial use.
     *
    ...
    // Gumroad product: https://y1uda.gumroad.com/l/droidslide
    internal const val GUMROAD_PRODUCT_ID = "ljLGrWd1HMYmLB1X7psWrg=="
    private const val PREFS_NAME = "droidslide_license"
}
